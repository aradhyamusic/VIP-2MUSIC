...
"""
        ...
        try:
            ...
            # await asyncio.sleep(0.1)
            await vips.edit_text("**🍁ѕтᴀ**")
            #  await asyncio.sleep(0.1)
            await vips.edit_text("**🍁ѕтᴀʀ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**🍁ѕтᴀʀᴛ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**🍁ꜱᴛᴀʀᴛɪ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**🍁ꜱᴛᴀʀᴛɪɴ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**🍁ꜱᴛᴀʀᴛɪɴɢ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**🍁ꜱᴛᴀʀᴛɪɴɢ.**")
