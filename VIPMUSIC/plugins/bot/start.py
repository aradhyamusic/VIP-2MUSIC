...
"""
        ...
        try:
            ...
            await vip.delete()
            vips = await message.reply_text("**⚡R**")
            await asyncio.sleep(0.1)
            await vips.edit_text("**⚡RA**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡RAD**")
            #  await asyncio.sleep(0.1)
            await vips.edit_text("**⚡RADH**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡RADHE**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡RADHE**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡R**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡RA**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡RAD**")
            ...
            await vips.edit_text("**⚡RADHE.**")
            await vips.edit_text("**⚡RADHE RADHE....**")
