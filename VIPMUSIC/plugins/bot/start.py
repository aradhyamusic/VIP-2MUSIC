...
"""
        ...
        try:
            ...
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡sᴛɐ**")
            #  await asyncio.sleep(0.1)
            await vips.edit_text("**⚡sᴛɐʀ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡sᴛɐʀᴛ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡sᴛɐʀᴛι**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡sᴛɐʀᴛιɳ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡sᴛɐʀᴛιɳɠ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡sᴛɐʀᴛιɳɠ.**")
