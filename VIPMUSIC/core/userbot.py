...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.send_message(config.LOG_GROUP_ID, "𝗔𝗦𝗦𝗜𝗦𝗧𝗔𝗡𝗧 𝗦𝗧𝗔𝗥𝗧𝗘𝗗❄️")
            except:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.send_message(config.LOG_GROUP_ID, "𝗔𝗦𝗦𝗜𝗦𝗧𝗔𝗡𝗧 𝗦𝗧𝗔𝗥𝗧𝗘𝗗❄️")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.send_message(config.LOG_GROUP_ID, "𝗔𝗦𝗦𝗜𝗦𝗧𝗔𝗡𝗧 𝗦𝗧𝗔𝗥𝗧𝗘𝗗❄️")
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING4:
            ...
            try:
                await self.four.send_message(config.LOG_GROUP_ID, "𝗔𝗦𝗦𝗜𝗦𝗧𝗔𝗡𝗧 𝗦𝗧𝗔𝗥𝗧𝗘𝗗❄️")
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING5:
            ...
            try:
                await self.five.send_message(config.LOG_GROUP_ID, "𝗔𝗦𝗦𝗜𝗦𝗧𝗔𝗡𝗧 𝗦𝗧𝗔𝗥𝗧𝗘𝗗❄️")
            except:
                LOGGER(__name__).error(
